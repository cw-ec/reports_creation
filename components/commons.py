...
def get_ed_name_from_code(code: int) -> str:
    ...
    ed_dict = {10001: 'Avalon', 10002: 'Bonavista—Burin—Trinity', 10003: 'Coast of Bays—Central—Notre Dame',
                   10004: 'Labrador',
                   10005: 'Long Range Mountains', 10006: "St. John's East / St. John's-Est",
                   10007: "St. John's South—Mount Pearl / St. John's-Sud—Mount Pearl", 11001: 'Cardigan',
                   11002: 'Charlottetown',
                   11003: 'Egmont', 11004: 'Malpeque', 12001: 'Cape Breton—Canso', 12002: 'Central Nova / Nova-Centre',
                   12003: 'Cumberland—Colchester', 12004: 'Dartmouth—Cole Harbour', 12005: 'Halifax',
                   12006: 'Halifax West / Halifax-Ouest', 12007: 'Kings—Hants', 12008: 'Sackville—Preston—Chezzetcook',
                   12009: 'South Shore—St. Margarets', 12010: 'Sydney—Victoria', 12011: 'West Nova / Nova-Ouest',
                   13001: 'Acadie—Bathurst', 13002: 'Beauséjour', 13003: 'Fredericton', 13004: 'Fundy Royal',
                   13005: 'Madawaska—Restigouche', 13006: 'Miramichi—Grand Lake', 13007: 'Moncton—Riverview—Dieppe',
                   13008: 'New Brunswick Southwest / Nouveau-Brunswick-Sud-Ouest', 13009: 'Saint John—Rothesay',
                   13010: 'Tobique—Mactaquac', 24001: 'Abitibi—Baie-James—Nunavik—Eeyou',
                   24002: 'Abitibi—Témiscamingue',
                   24003: 'Ahuntsic-Cartierville', 24004: 'Alfred-Pellan', 24005: 'Argenteuil—La Petite-Nation',
                   24006: 'Avignon—La Mitis—Matane—Matapédia', 24007: 'Beauce', 24008: 'Beauport—Limoilou',
                   24009: 'Bécancour—Nicolet—Saurel', 24010: 'Bellechasse—Les Etchemins—Lévis',
                   24011: 'Beloeil—Chambly',
                   24012: 'Berthier—Maskinongé', 24013: 'Thérèse-De Blainville',
                   24014: 'Pierre-Boucher—Les Patriotes—Verchères',
                   24015: 'Bourassa', 24016: 'Brome—Missisquoi', 24017: 'Brossard—Saint-Lambert',
                   24018: 'Rimouski-Neigette—Témiscouata—Les Basques', 24019: 'Charlesbourg—Haute-Saint-Charles',
                   24020: "Beauport-Côte-de-Beaupré-Île d'Orléans-Charlevoix", 24021: 'Châteauguay—Lacolle',
                   24022: 'Chicoutimi—Le Fjord', 24023: 'Compton—Stanstead', 24024: 'Dorval—Lachine—LaSalle',
                   24025: 'Drummond',
                   24026: 'Gaspésie—Les Îles-de-la-Madeleine', 24027: 'Gatineau', 24028: 'Hochelaga',
                   24029: 'Honoré-Mercier',
                   24030: 'Hull—Aylmer', 24031: 'Joliette', 24032: 'Jonquière', 24033: "La Pointe-de-l'Île",
                   24034: 'La Prairie',
                   24035: 'Lac-Saint-Jean', 24036: 'Lac-Saint-Louis', 24037: 'LaSalle—Émard—Verdun',
                   24038: 'Laurentides—Labelle',
                   24039: 'Laurier—Sainte-Marie', 24040: 'Laval—Les Îles', 24041: 'Longueuil—Charles-LeMoyne',
                   24042: 'Lévis—Lotbinière', 24043: 'Longueuil—Saint-Hubert', 24044: 'Louis-Hébert',
                   24045: 'Louis-Saint-Laurent',
                   24046: 'Manicouagan', 24047: "Mégantic—L'Érable", 24048: 'Mirabel', 24049: 'Montarville',
                   24050: 'Montcalm',
                   24051: "Montmagny—L'Islet—Kamouraska—Rivière-du-Loup", 24052: 'Mont-Royal / Mount Royal',
                   24053: 'Notre-Dame-de-Grâce—Westmount', 24054: 'Outremont', 24055: 'Papineau',
                   24056: 'Pierrefonds—Dollard',
                   24057: 'Pontiac', 24058: 'Portneuf—Jacques-Cartier', 24059: 'Québec', 24060: 'Repentigny',
                   24061: 'Richmond—Arthabaska', 24062: 'Rivière-des-Mille-Îles', 24063: 'Rivière-du-Nord',
                   24064: 'Rosemont—La Petite-Patrie', 24065: 'Marc-Aurèle-Fortin', 24066: 'Saint-Hyacinthe—Bagot',
                   24067: 'Saint-Jean', 24068: 'Saint-Laurent', 24069: 'Saint-Léonard—Saint-Michel',
